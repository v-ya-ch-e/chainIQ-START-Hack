...
SEED_RULES = [
    ...
    {
        "rule_id": "VAL-006",
        "rule_name": "Text/field contradiction detection (DEPRECATED)",
        "description": "Deprecated: contradiction detection is now handled by the direct LLM path in validate.py with a detailed prompt and temperature=0. This rule is kept inactive for audit trail purposes.",
        "rule_category": "hard_rule",
        "eval_type": "custom_llm",
        "scope": "request",
        "pipeline_stage": "validate",
        "eval_config": {
            "system_prompt": "Deprecated — see validate.py VALIDATION_SYSTEM_PROMPT",
